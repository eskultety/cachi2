FROM registry.access.redhat.com/ubi10@sha256:145a2d6e7e224d34fbe601832e3f133c11560e15b4074fad75c449387bb105a0 AS ubi
FROM mirror.gcr.io/library/golang:1.26.7-alpine AS golang
